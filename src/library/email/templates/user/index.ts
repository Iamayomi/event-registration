 ...
 */
export const emailVerificationTemplate = (username: string, code: number | string, subject?: string) => {
  return {
    subject: subject || `[${code}] Verify your account`,

    text: `Hello ${username}! Welcome to the EVENT REGISTRATION. We are so thrilled to have you onboard! Please use the code, ${code}, to verify your email.`,
                  ...
                  <div class="container">
                    <main>
                      ...
                      <div class="body">
                        ...
                        <p>
                          Welcome to the EVENT REGISTRATION! We are so thrilled to have you
                          onboard. <br />
                      ...
                      <div class="footer">
                        <small
                          ...
                          on EVENT REGISTRATION&trade;, <br />please ignore this email.</small
                        >
                      </div>
                    </main>
                  </div>
 ...
 * @returns {Object} HTML, text, and subject of the email
 */
export const emailVerificationResendTemplate = (username: string, code: number | string, subject?: string) => {
  return {
 ...
 * @returns {Object} HTML, text, and subject of the email
 */
export const resetPasswordTemplate = (username: string, code: number | string, subject?: string) => {
  return {
    subject: subject || `[${code}] Reset your password`,

    text: `Dear ${username}, you requested to reset your password on EVENT REGISTRATION. Use the 4-digit token below to initiate a password reset.`,
                  ...
                  <main>
                    <div class="body">
                      ...
                      <p>
                        ...
                        <strong>EVENT REGISTRATION&trade;.</strong> Use the 4-digit code below to
                    ...
                    <div class="ps">
                      <small>This message was intended for ${username}. If you did not request a
                        password reset fromEVENT REGISTRATION&trade;, please ignore this email.</small>
                    </div>
                  </main>
                </div>
              </body>
...
/**
 * Content of the mail sent after a user rsuccessfully changes or updates their password.
 * @param username Receiver's username
 * @param subject Subject of the message
 * @param timestamp Date object
 * @returns {Object} HTML, text, and subject of the email
 */
export const newPasswordSuccessTemplate = (username: string, subject?: string, timestamp: Date = new Date()) => {
  return {
                  ...
                  <main>
                    <div class="body">
                      ...
                      <p>
                        ...
                        <strong>EVENT REGISTRATION&trade;.</strong>
                      </p>
                      <p class="timestamp">
                        <strong>Timestamp: </strong> ${moment(timestamp).format("MMMM Do YYYY, h:mm:ss a")}
                      </p>
                    </div>

                    <div class="ps">
                      <small>This message was intended for ${username}. If you did not initiate a
                        password update on EVENT REGISTRATION&trade;, please ignore this email.</small>
                    </div>
                  </main>
                </div>
              </body>
